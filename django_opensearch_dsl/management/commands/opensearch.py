        ...
        for index in indices:
            ...
            try:
                if action == OpensearchAction.CREATE:
                    # If current index depends on many different models, add them to index._doc_types
                    # before indexing to make sure all mappings of different models are taken into account.
